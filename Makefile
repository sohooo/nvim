.PHONY: airgap-appimage airgap-bundle check-external-tools healthcheck migration-status update-plugins verify verify-airgap-appimage verify-airgap-bundle verify-plugins upgrade
