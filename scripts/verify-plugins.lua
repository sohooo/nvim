...
assert_cmd("ruby_lsp", { "ruby-lsp" })
assert_contains(vim.lsp.config.ruby_lsp.filetypes, "ruby", "ruby_lsp filetypes")
assert_contains(vim.lsp.config.ruby_lsp.filetypes, "eruby", "ruby_lsp filetypes")
assert_contains(vim.lsp.config.ruby_lsp.root_markers, "Gemfile", "ruby_lsp root markers")
assert(vim.lsp.config.ruby_lsp.init_options.formatter == "auto", "ruby_lsp formatter should use auto")
assert(vim.lsp.config.ruby_lsp.init_options.addonSettings["Ruby LSP Rails"].enablePendingMigrationsPrompt == false, "ruby_lsp should disable Rails pending migration prompt")
assert(vim.lsp.config.solargraph == nil, "solargraph should not be configured")
